...
namespace SimpleAuth.Migrations
{
    ...
    [Migration("20231208150729_TicketSeatModelAltered")]
    partial class TicketSeatModelAltered
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleAuth.Models.Ticket", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SimpleAuth.Models.TicketSeat", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SimpleAuth.Models.TicketSeat", b =>
                {
                    b.HasOne("SimpleAuth.Models.ShowSeat", "ShowSeats")
                        .WithMany()
                        .HasForeignKey("ShowSeatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SimpleAuth.Models.Ticket", "Tickets")
                        .WithMany()
